...
use pallas_primitives::conway::{
    ...
    MintedTransactionBody, MintedTx, NetworkId, PlutusData, PlutusScript, PseudoDatumOption,
    PseudoScript, PseudoTransactionOutput, RationalNumber, Value,
};
...
mod conway_tests {
    ...
    fn successful_mainnet_tx_with_plutus_v2_script() {
        ...
        add_ref_input_conway(&mtx.transaction_body, &mut utxos, ref_input_info);
        let acnt = AccountState {
            treasury: 261_254_564_000_000,
            reserves: 0,
        };
    ...
    fn successful_preview_tx_with_plutus_v2_script() {
        ...
        let env: Environment = Environment {
            prot_params: MultiEraProtocolParameters::Conway(mk_preview_params_epoch_30()),
            prot_magic: 2,
            block_slot: 2592005,
            network_id: 0,
            acnt: Some(acnt),
    ...
    fn successful_preprod_tx_with_plutus_v2_script() {
        ...
        let env: Environment = Environment {
            prot_params: MultiEraProtocolParameters::Conway(mk_preprod_params_epoch_100()),
            prot_magic: 1,
            block_slot: 41558438,
            network_id: 0,
            acnt: Some(acnt),
    ...
    fn min_fee_unreached() {
        ...
        conway_prot_params.minfee_a = 76; // This value was 44 during Babbage on mainnet.
        let acnt = AccountState {
            treasury: 261_254_564_000_000,
            reserves: 0,
        };
    ...
    fn too_many_collateral_inputs() {
        ...
        add_collateral_conway(&mtx.transaction_body, &mut utxos, collateral_info);
        let mut conway_prot_params: ConwayProtParams = mk_mainnet_params_epoch_365();
        conway_prot_params.max_collateral_inputs = 0; // This value was 3 during Babbage on mainnet
        let acnt = AccountState {
            treasury: 261_254_564_000_000,
            reserves: 0,
        };
    ...
    fn collateral_min_lovelace() {
        ...
        add_collateral_conway(&mtx.transaction_body, &mut utxos, collateral_info);
        let mut conway_prot_params: ConwayProtParams = mk_mainnet_params_epoch_365();
        conway_prot_params.collateral_percentage = 728; // This value was 150 during Babbage on
                                                        // mainnet.
        let acnt = AccountState {
            treasury: 261_254_564_000_000,
            reserves: 0,
    ...
    fn tx_ex_units_exceeded() {
        ...
        add_collateral_conway(&mtx.transaction_body, &mut utxos, collateral_info);
        let mut conway_prot_params: ConwayProtParams = mk_mainnet_params_epoch_365();
        conway_prot_params.max_tx_ex_units.mem = 3678343; // 1 lower than that of the transaction
        conway_prot_params.max_tx_ex_units.steps = 1304942838; // 1 lower than that of the transaction
        let acnt = AccountState {
            treasury: 261_254_564_000_000,
            reserves: 0,
        };
    ...
    fn mk_preview_params_epoch_30() -> ConwayProtParams {
        ConwayProtParams {
            system_start: chrono::DateTime::parse_from_rfc3339("2022-10-25T00:00:00Z").unwrap(),
            epoch_length: 432000,
            slot_length: 1,
